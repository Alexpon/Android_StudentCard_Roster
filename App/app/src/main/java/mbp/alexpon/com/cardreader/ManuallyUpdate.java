...
public class ManuallyUpdate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manually_update);
        inits();
        setListener();
        pendingSetting();
    ...
    private View.OnClickListener myListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.first:
                    Intent intent1 = new Intent(ManuallyUpdate.this, Perso.class);
                ...
                case R.id.sync:
                    ...
                    Intent intent2 = new Intent(ManuallyUpdate.this, SyncData.class);
                    ...
                    break;
                case R.id.back:
                    Intent intent3 = new Intent(ManuallyUpdate.this, MainActivity.class);
    ...
    private void pendingSetting(){
        Intent intent = new Intent(this, ManuallyUpdate.class);
